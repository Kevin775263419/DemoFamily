...
@property (copy, nonatomic)   NSArray *ad;
@property (assign, nonatomic) BOOL hasVisible;
@property (copy, nonatomic)   NSString *gsid;
@property (assign, nonatomic) NSInteger interval;
@property (copy, nonatomic)   NSArray *advertises;
@property (assign, nonatomic) NSInteger previousCursor;
@property (assign, nonatomic) NSInteger uveBlank;
@property (assign, nonatomic) NSInteger totalNumber;
@property (assign, nonatomic) NSInteger hasUnread;
@property (assign, nonatomic) NSInteger maxID;
@property (copy, nonatomic)   NSArray<WBStatus *> *statuses;
@property (copy, nonatomic)   NSArray *trends;
@property (assign, nonatomic) NSInteger nextCursor;
@property (assign, nonatomic) NSInteger sinceID;
