...
- (void)_layoutText {
    ...
    UIFont *font = [UIFont systemFontOfSize:kWBCellTextFontSize];
    CGFloat ascent = font.pointSize * 0.86;
    CGFloat descent = font.pointSize * 0.14;
//    CGFloat lineHeight = font.lineHeight;
    CGFloat lineHeight = font.pointSize * 1.34;
    _textHeight =  kWBCellPaddingText + kWBCellPaddingText + ascent + descent + (_textLayout.rowCount - 1) * lineHeight;
