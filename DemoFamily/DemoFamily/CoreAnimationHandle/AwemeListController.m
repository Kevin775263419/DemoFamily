...
- (void)setUpView {
    ...
    //Setup 'contentInset' x distant of Screens height
...
- (void)addRefreshLabel {
    ...
    _refreshLabel.text = @"Cancel";
    _refreshLabel.textColor = [UIColor blueColor];
    _refreshLabel.backgroundColor = [UIColor greenColor];
    [self.view addSubview:_refreshLabel];
}

- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    UITouch *touch = touches.anyObject;
    CGPoint point = [touch locationInView:_refreshLabel];
    if (CGRectContainsPoint(_refreshLabel.bounds, point)) {
...
- (void)loadData:(NSInteger)pageIndex pageSize:(NSInteger)pageSize {
    ...
    dict[@"page"] = [NSString stringWithFormat:@"%ld",(long)pageIndex];
    dict[@"size"] = [NSString stringWithFormat:@"%ld",(long)pageSize];
    dict[@"uid"] = _uid;
    [NetworkHelper getWithUrlPath:FindAwemeFavoriteByPagePath request:dict success:^(id data) {
        AwemeListResponse *response = [AwemeListResponse modelWithJSON:data];
